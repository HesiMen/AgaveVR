Shader "Custom/Vertex_Displacement"
{
    Properties
    {
        ...
        _ScrollSpeedDamper ("Scroll Speed", Float) = 1
        _FluffFactor ("Fluffiness", Range(0, 1)) = .125
        _Coverage ("Coverage", Range(0,1)) = .25
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert (appdata v)
            {
                ...
                v.uv2.xy += _Time.y / (_ScrollSpeedDamper / 2);
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                fixed4 light = lightIntensity * (_LightColor0 / 1.25);
                ...
                col = ((col < _Coverage) ? 0 : smoothstep(_FluffFactor, 1, col));
                col.rgb = 1 - col.rgb;
