...
using DG.Tweening;
public abstract class SnapAgaveBase : UnityEngine.XR.Interaction.Toolkit.LocomotionProvider
{
    ...
    protected void Update()
    {
        ...
        if (amount != 0f)
        {
            ...
            DOVirtual.Float(0f, amount, speedTurn, curAmmount => { xrRig.RotateAroundCameraUsingRigUp(curAmmount); }).OnComplete(ZeroNow); ;
